...
#return the required data for the given indus number(delivery code, ecu type, sw version, cr number, cr creation)
...
if not is_ready_for_to_xl: #if there is ungrouped files, error messages will appear and will not proceed to later stages of process.
	message_box("Error", "There are non-grouped files. Please check error-log file.")
	for mis in mismatch_files:
		add_error_log("This file is mismatched " + mis )
