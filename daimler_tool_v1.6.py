...
destination_xl = 'Follow-up_CR_CN_ECU_Daimler _solenoide_piezo.xlsx'
destination_sheet_save_as = 'Follow-up_CR_CN_ECU_Daimler _solenoide_piezo.xlsx'
...
def check_num_of_files(folder, num):
    ...
    num_of_s19 = len([name for name in os.listdir(folder) if name.endswith('.s19')])
...
if not is_ready_for_to_xl:
    print("There are ungrouping files. Please check them.")
    message_box("Error", "There are ungrouping files. Please check them.")
